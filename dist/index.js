...
var ModelFilters = require('../src/glyph-manipulate/ModelFilters'); // The parameters manipulatable by the UI elements
...
globalParams.bindUI = function () {
  ...
  $('.binded').each(function (index, elem) {
    ...
    $(elem).on('input', function () {
      _this[param] = Number.parseFloat(elem.value);
      var event = new CustomEvent('param-change', {
        detail: param
      });
      window.dispatchEvent(event);
    });
    $(elem).val(_this[param]);
  });
...
},{"../src/glyph-manipulate/GlyphModel":3,"../src/glyph-manipulate/ModelFilters":4,"../src/utils/GlyphPreviewPanel":5}],2:[function(require,module,exports){
